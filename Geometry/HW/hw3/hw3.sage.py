...
# This file was *autogenerated* from the file hw3.sage
from sage.all_cmdline import *   # import sage library

_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_200 = Integer(200); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_190 = Integer(190); _sage_const_0 = Integer(0); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_185 = Integer(185); _sage_const_67 = Integer(67); _sage_const_18 = Integer(18); _sage_const_205 = Integer(205); _sage_const_86 = Integer(86); _sage_const_187 = Integer(187); _sage_const_81 = Integer(81); _sage_const_83 = Integer(83); _sage_const_p03 = RealNumber('.03'); _sage_const_152 = Integer(152); _sage_const_150 = Integer(150); _sage_const_159 = Integer(159); _sage_const_2p0 = RealNumber('2.0'); _sage_const_216 = Integer(216); _sage_const_194 = Integer(194); _sage_const_13 = Integer(13); _sage_const_12 = Integer(12); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_p1 = RealNumber('.1'); _sage_const_15 = Integer(15); _sage_const_14 = Integer(14); _sage_const_19 = Integer(19); _sage_const_155 = Integer(155); _sage_const_50 = Integer(50); _sage_const_123 = Integer(123); _sage_const_121 = Integer(121); _sage_const_126 = Integer(126); _sage_const_100 = Integer(100); _sage_const_101 = Integer(101); _sage_const_103 = Integer(103); _sage_const_1000 = Integer(1000); _sage_const_106 = Integer(106); _sage_const_300 = Integer(300); _sage_const_16 = Integer(16)## This file (hw3.sage) was *autogenerated* from the file hw3.tex.
import sagetex
_st_ = sagetex.SageTeXProcessor('hw3')
_st_.blockbegin()
try:
...
_st_.blockend()
try:
 _st_.inline(_sage_const_22 , B)
except:
 _st_.goboom(_sage_const_216 )
try:
 _st_.inline(_sage_const_23 , C)
except:
 _st_.goboom(_sage_const_216 )
_st_.endofdoc()
